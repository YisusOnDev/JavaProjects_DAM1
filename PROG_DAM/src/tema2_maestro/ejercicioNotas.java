...
public class ejercicioNotas {
	public static void main(String[] args) {
		...
		while (true) { // Bucle para que se ejecute continuamente...
			System.out.println(
					"Calculadora de notas de Alumnos");
			System.out.println("------------------------------");
			System.out.println("Introduce el nombre del profesor");
			String nombreProfesor = sc.nextLine(); // Pedimos el nombre del profesor
			System.out.println("------------------------------");
			System.out.println("Escribe la asignatura de la cual se va a calcular la nota");
			String asignatura = sc.nextLine(); // Pedimos la asignatura
			System.out.println("------------------------------");
			System.out.println("Introduce el nombre del alumno");
			String nombreAlumno = sc.nextLine(); // Pedimos el nombre del alumno
			System.out.println("------------------------------");
			System.out.println("Introduce el apellido del alumno");
			String apellidoAlumno = sc.nextLine(); // Pedimos el apellido del alumno
			System.out.println("------------------------------");
			System.out.println("Introduce la nota númerica que tiene el alumno en la asignatura");
			Double nota = sc.nextDouble(); // Pedimos la nota
			System.out.println("------------------------------");

			String notaTxt = "ERROR";
			//Calculamos la cualitativa.
			if (nota >= 0 && nota <= 2.99) {
