...
public class Snake {
    ...
    private ArrayList<Square> listaCuadrados;
    ...
    public Snake(){
        ...
        listaCuadrados.add(new Square(60,60,20,(int)(Math.random()*16000000)));
        
        //siempre hacia abajo al principio
        iDireccion = Square.ABAJO;    
    ...
    public void moverse(){
        ...
        nuevaCabeza = new Square(antiguaCabeza.getX(),antiguaCabeza.getY(),antiguaCabeza.getLado(),antiguaCabeza.getColor());
    ...
    private boolean seHaSalido(int iAlto, int iAncho) {
        ...
        Square cabeza = listaCuadrados.get(0);
    ...
    public void cambiaDireccion(int key) {
    	if (key == KeyEvent.VK_A) {
    		iDireccion = Square.IZQ;
    	} else if (key == KeyEvent.VK_S) {
    		iDireccion = Square.ABAJO;
    	} else if (key == KeyEvent.VK_W) {
    		iDireccion = Square.ARRIBA;
    	} else if (key == KeyEvent.VK_D) {
    		iDireccion = Square.DER;
    	}
    }
